...
public class MapitaSP<K extends Comparable<K>,V extends Comparable<V>> extends MapView {
		...
		setOnMapReadyHandler( new MapReadyHandler() 
		{
			...
			public void onMapReady(MapStatus status)
			{
				if ( status == MapStatus.MAP_STATUS_OK )
				{
					...
					while(vertex.hasNext() && contador < 10000)
					{
